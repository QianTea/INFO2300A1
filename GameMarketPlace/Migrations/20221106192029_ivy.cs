...
{
    public partial class ivy : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RegisteredEventId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EventId = table.Column<int>(type: "int", nullable: false),
                    MemberId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegisteredEvents", x => x.RegisteredEventId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhysicalEditor = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    APSuiteNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WishListId = table.Column<int>(type: "int", nullable: true),
                    PromotionalEmail = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "CreditCards",
                columns: new[] { "CreditCardId", "CVV", "CardNumber", "ExpiryDate", "MemberId" },
                values: new object[,]
                {
                    { 1, 123, "1234-1234-1234", new DateTime(2024, 11, 6, 14, 20, 29, 194, DateTimeKind.Local).AddTicks(9465), "abcd123" },
                    { 2, 123, "1234-1234-1234", new DateTime(2025, 11, 6, 14, 20, 29, 194, DateTimeKind.Local).AddTicks(9470), "abcd1234" }
                });

            migrationBuilder.InsertData(
                table: "Events",
                columns: new[] { "EventId", "EventDate", "EventDetails", "EventName" },
                values: new object[] { 1, new DateTime(2022, 11, 11, 14, 20, 29, 194, DateTimeKind.Local).AddTicks(9508), "An event to test the events features", "Testing" });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "RegisteredEventId", "EventId", "MemberId" },
                values: new object[] { 1, 1, "abc123" });

            migrationBuilder.InsertData(
                table: "Wishlists",
                columns: new[] { "WishlistId", "GameId", "UserId" },
                values: new object[] { 1, 1, "46e733d2 - 6e60 - 4c7e - afc9 - 22796a13a145" });
            ...
            migrationBuilder.InsertData(
                table: "Games",
                columns: new[] { "GameId", "GameName", "GamePrice", "GenreId", "Inventory", "PhysicalEditor", "Publisher", "ReleaseDate" },
                values: new object[] { 1, "Call of Duty", 200.0, 4, 100, "Infinity Ward", "Battle.NET", new DateTime(2022, 10, 28, 0, 0, 0, 0, DateTimeKind.Unspecified) });
